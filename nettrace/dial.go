...
// ResolverDialTraceEnv trace published after every attempt to dial a nameserver.
type ResolverDialTraceEnv struct {
	ResolvDial  TraceID
	ParentDial  TraceID
	Nameserver  string
...
func (ResolverDialTraceEnv) isInternalNetTrace() {}
