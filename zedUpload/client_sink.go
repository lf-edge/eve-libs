...
// BoltBatchSink persists mirrored batches and can export them to a single JSON file.
...
func (s *BoltBatchSink) Close() error { return s.db.Close() }

// Handler returns a nettrace.BatchCallback to pass into WithBatchMirror.
...
// ExportToJSON writes one JSON file with everything persisted in Bolt.
