...
func (ctx *DronaCtx) NewSyncerDest(tr SyncTransportType, UrlOrRegion, nettracePATH, PathOrBkt string, auth *AuthInput, opts ...SyncerDestOption) (DronaEndPoint, error) {
	...
	case SyncAwsTr:
		...
		syncEp.hClientWrap.nettracePath = nettracePATH
